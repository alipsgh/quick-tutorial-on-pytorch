...
from utils.nn import get_pytorch_activation, get_pytorch_optimizer, get_pytorch_criterion


class AE(nn.Module):

    def __init__(self, input_dim, encoders_dim, encoder_activations,
                 criterion='binarycrossentropy', optimizer='adam', learning_rate=0.001):
